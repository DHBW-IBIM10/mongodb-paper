...
Most terms can roughly be mapped to their SQL counterpart. An overview of key terms
...
The driver allows interacting with MongoDB through Ruby by employing similar constructs to the examples above using the Mongo shell, however most developers use an Object Document Mapper(ODM) to gain higher-level abstractions and modeling functionality.\footcite[Cf.][]{mongo_ruby_driver} This paper will focus on Mongoid, one of the most popular ODMs.
